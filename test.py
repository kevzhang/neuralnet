...
class TestNeuralNet(unittest.TestCase):
    ...
    def test_init_no_error(self):
        NeuralNet(3, 3, [3], sigmoid_p=12.34, sigmoid_s=17.1, weight_provider=constant_weight_provider)
