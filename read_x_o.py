from neural_net.npnn import SIGMOID, NeuralNet
...
nn_params = NeuralNet.Params(width * height, 1, [16], sigmoid_s=0.0)
...
(nn, err) = train_until(nn_params, nn_training_data, initial_step=0.5, threshold=1)
